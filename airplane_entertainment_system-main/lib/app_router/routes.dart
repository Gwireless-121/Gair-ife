...
@TypedStatefulShellRoute<HomeScreenRouteData>(
  branches: [
    ...
    TypedStatefulShellBranch<CrewPanelPageBranchData>(
      routes: [
        TypedGoRoute<CrewPanelPageRouteData>(
          name: 'crew',
          path: '/crew',
        ),
      ],
    ),
    TypedStatefulShellBranch<YouTubePlayerPageBranchData>(
      routes: [
        TypedGoRoute<YouTubePlayerPageRouteData>(
          name: 'youtube',
          path: '/youtube',
        ),
      ],
